...
const AwesomeToast=({message,icon})=>(
  <div className='animate-slide-in fixed bottom-6 right-6
  flex items-center bg-gradient-to-br from-amber-500 to-amber-600
  px-6 py-4 rounded-lg shadow-lg border-2 border-r-amber-300/20'>
    <span className='text-2xl mr-3 text-[#2D1B0E]'>
        {icon}
    </span>
    ...
    <div className='min-h-screen flex items-center justify-center bg-[#1a120b] p-4'>
      ...
      border-4 border-amber-700/30 transform transition-all duration-300 hover:shadow-2xl'>
         ...
         <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          className='w-full px-4 py-3 rounded-lg bg-[#2D120E] text-amber-100 placeholder-amber-400 focus:outline-none
          ...
          focus:ring-2 focus:ring-amber-600 transition-all duration-200 hover:scale-[1.02] 'required />
           ...
           <button type='submit' className='w-full py-3  bg-gradient-to-r from-amber-400 to-amber-600 text-[#2D1B0E] font-bold
                         rounded-lg flex items-center justify-center gap-2 hover:scale-105 transition-transform duration-300 hover:shadow-lg
                         '>
                           Sign Up 
          ...
          <div className='text-center mt-6'>
           <Link to='/login'  className=' group inline-flex items-center 
           text-amber-400 hover:text-amber-600 transition-all duration-300'>
