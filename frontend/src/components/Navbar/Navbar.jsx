...
const Navbar = () => {
  ...
  const renderDesktopAuthButton = () => {
    return isAuthenticated ? (
      <button
        ...
        className="px-3 md:px-3 lg:px-6 py-1.5 md:py-2 lg:py-3 bg-gradient-to-br from-amber-400
  ...
  const renderMobileAuthButton = () => {
    return isAuthenticated ? (
      <button
        onClick={handleLogout}
        className="w-full px-4 py-3 bg-gradient-to-br from-amber-700  text-[#2D1B0E] rounded-xl font-semibold flex items-center
  ...
  return (
    <nav
      className="bg-[#2D1B0E] border-b-8 border-amber-900/30 shadow-amber-900 sticky
   top-0 z-50 shadow-[0_25px_50px_-12px] font-vibes group/nav overflow-x-hidden"
    ...
    shadow-[0_0_20px] shadow-amber-500/30"
      ...
      lg:-translate-x-6 ml-0 md:ml-2"
          >
            <div
              className="absolute -inset-4 bg-amber-500/10 rounded-full blur--
        ...
        group-hover:rotate-12 group-hover:text-amber-400 hover:drop-shadow-[0_0_15px] hover:drop-shadow-500/50"
            ...
            <div className="flex flex-col relative ml-2 max-w-[140px] md:max-w-[160px] lg:max-w-none">
              <NavLink
                to="/"
                className="text-2xl md:text-xl lg:text-4xl bg-gradient-to-r from-amber-400
          to-amber-600 bg-clip-text text-transparent font-monsieur tracking-wider drop-shadow-[0_2px_2px] "
              >
                Foodie-Frenzy
              </NavLink>
              <div
                className="h-[3px] bg-gradient-to-r from-amber-600/30 via-amber-400/50 to-amber-600/30 w-full
        ...
        text-amber-500 group-hover:text-amber-300 transition-all"
         ...
         group-hover:w-full"
            ...
            md:ml-3 lg:ml-6 md:mr-3 lg:mr-4"
            >
              <NavLink
                to="/cart"
...
hover:shadow-lg hover:shadow-amber-500/30 shadow-amber-900/20 shadow-md  "
              >
  ...
  hover:shadow-lg hover:shadow-amber-500/30"
      ...
      {showLoginModal && (
        ...
        w-full max-w-[480px] relative border-4 border-amber-700/30  shadow-amber-500/30 shadow-[0_0_30px]  "
          >
            <button
              onClick={() => navigate("/")}
