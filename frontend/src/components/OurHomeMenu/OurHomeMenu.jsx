        ...
        px-4 sm:px-6 lg:px-8'>
            <div className=' max-w-7xl mx-auto'>
                ...
                <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4'>
                        {displayItems.map((item,i)=>{
                            ...
                            return (
                                ...
                                border-amber-800/30 backdrop-blur-sm flex flex-col transition-all duration-500' style={{'--index':i}}>

                                    <div className='relative h-48 sm:h-60 flex items-center justify-center bg-blend-multiply/10'>
                                    <img src={item.image} alt={item.name}
                                    className='max-h-full max-w-full object-contain transition-all duration-700' />    
                                    </div>
                                    <div className='p-4 sm:p-6 flex flex-col flex-grow'>
                                        <div className='absolute top-0 left-1/ -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-transparent via-amber-800/50 to-transparent opacity-50  transition-all duration-300'/>
                                       ...
                                       <div className='mt-auto flex items-center gap-4 justify-between'>
                                        ...
                                        <span className='text-xl font-bold text-amber-300 font-dancingscrpt'>
                                            ${item.price}
                                        </span>
                                        </div>
                                                    <div className='flex items-center gap-2'>
                                                     {
                                                        quantity > 0 ?(
                                                            ...
                                                            <button className='w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800/50 transition-colors' 
                ...
                <div className='flex justify-center mt-16'>
                                                        <Link className='bg-amber-900/30 border-2 border-amber-800/30  text-amber-100 px-8 sm:px-10 py-3 rounded-full font-cinzel uppercase
                                                        tracking-widest transition-all duration-300 hover:bg-amber-800/40 hover:text-amber-50 hover:scale-105 hover:shadow-lg  hover:shadow-amber-900/20 backdrop-blur-sm' to='/menu'>
                                                            Explore Full Menu
                                                        </Link>
                                                    </div>
            </div>
