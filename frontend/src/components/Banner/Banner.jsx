      ...
      >
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10 ">
          ...
          <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left">
            <h1
              className="text-4xl sm:text-5xl md:text-4xl lg:text-6xl font-bold leading-tight font-serif
              drop-shadow-md "
            >
              We're Here <br />
            ...
            <p className="text-lg md:text-lg lg:text-xl font:playfair italic sm:text-xl text-amber-100
             ...
             Best cooks and best deleivery guys  all at your service.Hot tasty food will reach you in 60 minutes.
            </p>
