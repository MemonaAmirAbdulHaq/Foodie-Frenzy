        ...
        <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
          <div className='space-y-4 sm:space-y-8 px-4 sm:px-0'>
            <h2 className='text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight'>
                <span className='font-cursive text-4xl sm:text-3xl md:text-6xl bg-gradient-to-r from-amber-400
            ...
            <p className=' text-base sm:text-lg md:text-xl  opacity-90 leading-relaxed max-w-xl font-serif
            italic border-l-4 bg-amber-500/60 pl-4 sm:pl-6 bg-gradient-to-r from-white/5 to-transparent'>
             "In our kitchen,passions meet precision.We craft not just meals,but culinary journeys
             that ignite the senses and create unforgettable memories. Each dish is a masterpiece, a symphony of flavors that tells a story of love, culture, and creativity. Welcome to a world where every bite is an experience, and every meal is a celebration of life."
                ...
                {aboutfeature.map((item,i)=>(
                  <div key={i} className={`flex flex-col items-center justify-center gap-3 sm:gap-4 transition-transform duration-300 p-4 sm:p-5 hover:translate-x-2`}>
                    ...
                    <div className='text-center'>
                      <h3 className='text-xl sm:text-2xl font-cursive font-bold'>{item.title}</h3>
               ...
               group transform hover:scale-[1.01] transition-all duration-500 '>
                ...
                duration-500 shadow-2xl shadow-black/50'>
                    ...
                    <img src={AboutImage} alt="w-full h-auto object-cover aspect-[3/4] transform -rotate-1 hover:rotate-0 transition-all duration-500" />
