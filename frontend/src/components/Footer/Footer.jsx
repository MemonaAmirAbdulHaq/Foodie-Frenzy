...
<form onSubmit={handleSubmit} className='relative mt-4 group'>
  ...
  <div className='relative'>
    ...
    onChange={e=>setEmail(e.target.value)} className='w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none
    focus:border-b-amber-400 focus:ring-4 focus:ring-amber-400/20 transition-all duration-300 placeholder-amber-200/50 pr-24' required />
    <button type='submit' className='absolute right-1 top-1 bg-gradient-to-br from-amber-300
    ...
    flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-500   '>
      ...
      <div className='flex justify-center'>
        <div className='space-y-4'>
            <h3 className='text-xl font-semibold mb-4 border-1-4 border-amber-400 pl-3 font-merriweather
               ...
               <div className='space-y-4'>
                ...
                <div className='flex space-x-4'>
                   {socialIcons.map(({icon:Icon, link,color, label},idx)=>(
                    ...
                    className='text-2xl bg-amber-400/10 p-3 rounded-full hover:bg-amber-400/20 hover:110 transition-all duration-300 relative group'
                    style={{color}}>
    ...
    <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
      ...
      <div className='group inline-block'> 
        <a href="https://portfolio-m-ebon.vercel.app/" target='_blank' className='text-lg font-sacramento bg-gradient-to-r from-amber-400 via-amber-500
